...
sealed class RsDiagnostic(
    ...
    class FunctionImplDoesntMatchTraitDefError(
        element: PsiElement,
        private val name: String
    ) : RsDiagnostic(element) {
        override fun prepare() = PreparedAnnotation(
            ERROR,
            E0053,
            "Method `$name` has an incompatible type for trait"
        )
    }
}

enum class RsErrorCode {
    E0004, E0013, E0015, E0023, E0025, E0026, E0027, E0040, E0044, E0046, E0049, E0050, E0053, E0054, E0057, E0060, E0061, E0069, E0081, E0084,
